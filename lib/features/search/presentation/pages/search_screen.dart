...
class SearchScreen extends StatelessWidget {
  ...
  Widget _buildUIView(BuildContext context) => Expanded(
    ...
    child: BlocBuilder<SearchBloc, SearchState>(
      builder: (context, state) {
        return AsyncViewBuilder<List<PropertyUnitEntity>>(
          ...
          onSuccess: (units) => ListView.builder(
            itemExtent: 350.h,
            padding:
                EdgeInsets.zero, // Ensures list starts exactly where you want
